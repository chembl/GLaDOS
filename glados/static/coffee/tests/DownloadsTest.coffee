describe "Downloads", ->
  ...
  describe "A simple object download", ->
    ...
    it 'A. generates a correct json file', (done) ->
      ...
      $.get '/static/testData/DownloadTestA.json', (data) ->

        expectedFileContent = JSON.stringify(data)
        expect(fileStrContent).toBe(expectedFileContent)
        done()
    ...
    it 'B. generates a correct csv file', (done) ->
      ...
      $.get '/static/testData/DownloadTestB.csv', (expectedFileContent) ->
