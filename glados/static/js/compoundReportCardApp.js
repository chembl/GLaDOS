...
var initCNCView, initCalcCompPropertiesView, initCompFeaturesView, initCompMechanismsOfActionView, initCompMoleculeFormsListView, initCompRepsView, initCompound, initCompoundImageView, initIFrameLazyLoader, initMechanismOfAction, initMechanismOfActionList, initMechanismOfActionRowView, initMoleculeFormsList, initPieView;
...
initCalcCompPropertiesView = function(model, top_level_elem) {
  var calcCompPropView;
...
initIFrameLazyLoader = function(model, top_level_elem) {
  var iFrameLazyLoader;
