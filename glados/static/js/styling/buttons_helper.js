...
var contract, expand, hideExpandableMenu, hideExpandableMenuWrapper, initCroppedContainers, initCroppedTextFields, initExpendableMenus, setLessText, setMoreText, showExpandableMenu, toggleCroppedContainerWrapper, toggleExpandableMenuWrapper;
...
initCroppedTextFields = function() {
  return $('.cropped-text-field').each(function() {
    var download_text_btn, input_field;
    ...
    return download_text_btn.attr('href', 'data:text/html,' + input_field.attr('value'));
  });
};
