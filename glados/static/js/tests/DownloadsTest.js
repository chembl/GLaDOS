...
describe("Downloads", function() {
  var aspirin, data, testJSONFile, testTextFile;
  data = {
  ...
  aspirin.set(data);
  describe("A simple object download", function() {
    it('A. generates a correct json file', function(done) {
      var fileStrContent;
      fileStrContent = aspirin.downloadJSON('DownloadTestA.json');
      return testJSONFile(fileStrContent, '/static/testData/DownloadTestA.json', done);
    });
    return it('B. generates a correct csv file', function(done) {
      var fileStrContent;
      fileStrContent = aspirin.downloadCSV('DownloadTestB.csv');
      return testTextFile(fileStrContent, '/static/testData/DownloadTestB.csv', done);
    });
  });
  describe("A model with custom download object", function() {
    ...
    it('D. generates a correct json file', function(done) {
      ...
      return testJSONFile(fileStrContent, '/static/testData/DownloadTestD.json', done);
    });
  ...
  return testJSONFile = function(currentContent, expectedFileUrl, done) {
    return $.get(expectedFileUrl, function(expectedFileContent) {
