...
describe("Target hierarchy tree", function() {
  var getCollapsedNodesListStr, getExpandedNodesListStr, getHiddenNodesListStr, getIncompleteNodesListStr, getNodeFromID, getSelectedNodesListStr, getShownNodesListStr, getUnSelectedNodesListStr, targetTree;
  ...
  return getHiddenNodesListStr = function() {
    var all_nodes;
    all_nodes = targetTree.get('all_nodes').models;
    return _.map(_.filter(all_nodes, function(model) {
      return !model.get('show');
