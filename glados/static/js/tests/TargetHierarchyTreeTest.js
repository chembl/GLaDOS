...
describe("Target hierarchy tree", function() {
  var getCollapsedNodesListStr, getExpandedNodesListStr, getFocusedNodesListStr, getFoundNodesListStr, getHiddenNodesListStr, getIncompleteNodesListStr, getNodeFromID, getSelectedNodesListStr, getShownNodesListStr, getUnSelectedNodesListStr, targetTree;
  ...
  it("expands a node's ancestry", function(done) {
    var leaf_node, shown_nodes;
    leaf_node = getNodeFromID('9');
  ...
  it("focuses only one node at a time", function(done) {
    var focusedNodes, nodeA, nodeB;
  ...
  return getFocusedNodesListStr = function() {
    var all_nodes;
    all_nodes = targetTree.get('all_nodes').models;
    return _.map(_.filter(all_nodes, function(model) {
