...
import glados.ws2es.denormalization.mol_file_helper as mol_file_helper
from glados.ws2es.denormalization.activity_handler import ActivityDenormalizationHandler
from glados.ws2es.denormalization.atc_class_handler import ATCClassDenormalizationHandler
from glados.ws2es.denormalization.assay_handler import AssayDenormalizationHandler
from glados.ws2es.denormalization.binding_site_handler import BindingSiteHandler
from glados.ws2es.denormalization.compound_handler import CompoundDenormalizationHandler
from glados.ws2es.denormalization.cell_handler import CellDenormalizationHandler
from glados.ws2es.denormalization.compound_record_handler import CompoundRecordDenormalizationHandler
from glados.ws2es.denormalization.document_handler import DocumentDenormalizationHandler
from glados.ws2es.denormalization.document_similarity_handler import DocumentSimilarityHandler
from glados.ws2es.denormalization.drug_handler import DrugDenormalizationHandler
from glados.ws2es.denormalization.drug_indication_handler import DrugIndicationDenormalizationHandler
from glados.ws2es.denormalization.metabolism_handler import MetabolismDenormalizationHandler
from glados.ws2es.denormalization.mechanism_handler import MechanismDenormalizationHandler
from glados.ws2es.denormalization.organism_handler import OrganismDenormalizationHandler
from glados.ws2es.denormalization.protein_class_handler import ProteinClassDenormalizationHandler
from glados.ws2es.denormalization.source_handler import SourceDenormalizationHandler
from glados.ws2es.denormalization.target_component_handler import TargetComponentDenormalizationHandler
from glados.ws2es.denormalization.target_prediction_handler import TargetPredictionDenormalizationHandler
from glados.ws2es.denormalization.target_handler import TargetDenormalizationHandler
from glados.ws2es.denormalization.tissue_handler import TissueDenormalizationHandler
