...
import glados.ws2es.mappings.es_chembl_drug_indication_mapping as drug_indication_mapping
from glados.ws2es.denormalization.compound_family_helper import CompoundFamiliesDir
from glados.ws2es.es_util import DefaultMappings, create_idx, delete_idx

from glados.ws2es.resources_description import MOLECULE, DRUG_INDICATION, DRUG_INDICATION_BY_PARENT
import sys
