...
from glados.ws2es.resources_description import ALL_WS_RESOURCES, RESOURCES_BY_IDX_NAME
...
import traceback
import sys
from glados.ws2es.util import get_js_path_from_dict
...
FILE_HEADER += 'from glados.ws2es.es_util import DefaultMappings\n'
FILE_HEADER += '\n'
...
def compare_mappings(resources=None):
    ...
    import glados.ws2es.mappings_skeletons.es_chembl_activity_mapping as es_chembl_activity_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_activity_supplementary_data_by_activity_mapping as \
        es_chembl_activity_supplementary_data_by_activity_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_assay_mapping as es_chembl_assay_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_assay_class_mapping as es_chembl_assay_class_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_atc_class_mapping as es_chembl_atc_class_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_binding_site_mapping as es_chembl_binding_site_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_biotherapeutic_mapping as es_chembl_biotherapeutic_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_cell_line_mapping as es_chembl_cell_line_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_chembl_id_lookup_mapping as es_chembl_chembl_id_lookup_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_compound_record_mapping as es_chembl_compound_record_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_document_mapping as es_chembl_document_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_document_similarity_mapping as \
        es_chembl_document_similarity_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_drug_mapping as es_chembl_drug_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_drug_indication_mapping as es_chembl_drug_indication_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_go_slim_mapping as es_chembl_go_slim_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_mechanism_mapping as es_chembl_mechanism_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_metabolism_mapping as es_chembl_metabolism_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_molecule_mapping as es_chembl_molecule_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_molecule_form_mapping as es_chembl_molecule_form_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_organism_mapping as es_chembl_organism_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_protein_class_mapping as es_chembl_protein_class_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_source_mapping as es_chembl_source_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_target_mapping as es_chembl_target_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_target_component_mapping as es_chembl_target_component_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_target_prediction_mapping as es_chembl_target_prediction_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_target_relation_mapping as es_chembl_target_relation_mapping
    import glados.ws2es.mappings_skeletons.es_chembl_tissue_mapping as es_chembl_tissue_mapping
