        ...
        '_doc':
        {
            'properties':
            {
                ...
                'supplementary_data':
                {
                    'properties':
                    {
                        'as_id': DefaultMappings.ID_REF,
                        # EXAMPLES:
                        # '177274' , '93915' , '191456' , '176696' , '57221' , '118867' , '147811' , '42363' , '192054'
                        # , '206884'
                        'comments': DefaultMappings.KEYWORD,
                        # EXAMPLES:
                        # 'SAMPLE_ID: 0365011' , 'SAMPLE_ID: 0227011' , 'SAMPLE_ID: 0382091' , 'SAMPLE_ID: 0350101' , 'S
                        # AMPLE_ID: 0154151' , 'SAMPLE_ID: 0263091' , 'SAMPLE_ID: 0307161' , 'SAMPLE_ID: 0117161' , 'SAM
                        # PLE_ID: 0382161' , 'SAMPLE_ID: 0409161'
                        'relation': DefaultMappings.KEYWORD,
                        # EXAMPLES:
                        # '=' , '=' , '=' , '=' , '=' , '=' , '=' , '=' , '=' , '='
                        'rgid': DefaultMappings.ID_REF,
                        # EXAMPLES:
                        # '13578' , '9714' , '14268' , '13550' , '8370' , '10950' , '12153' , '6461' , '14298' , '1707'
                        'standard_relation': DefaultMappings.KEYWORD,
                        # EXAMPLES:
                        # '=' , '=' , '=' , '=' , '=' , '=' , '=' , '=' , '=' , '='
                        'standard_text_value': DefaultMappings.KEYWORD,
                        # EXAMPLES:
                        # 'minimal' , 'slight' , 'minimal' , 'slight' , 'minimal' , 'slight' , 'minimal' , 'slight' , 's
                        # light' , 'slight'
                        'standard_type': DefaultMappings.KEYWORD,
                        # EXAMPLES:
                        # 'RETIRBC' , 'RETIRBC' , 'EOSLE' , 'RETIRBC' , 'HCT' , 'MCHC' , 'PLAT' , 'HCT' , 'LYMLE' , 'HCT
                        # '
                        'standard_units': DefaultMappings.KEYWORD,
                        # EXAMPLES:
                        # '%' , '%' , '%' , '%' , '%' , '%' , 'cells.uL-1' , '%' , '%' , '%'
                        'standard_value': DefaultMappings.DOUBLE,
                        # EXAMPLES:
                        # '7.9' , '7.1' , '1' , '5.7' , '37.4' , '34.3' , '1087000' , '44.2' , '79' , '46.3'
                        'text_value': DefaultMappings.KEYWORD,
                        # EXAMPLES:
                        # 'minimal' , 'slight' , 'minimal' , 'slight' , 'minimal' , 'slight' , 'minimal' , 'slight' , 's
                        # light' , 'slight'
                        'type': DefaultMappings.KEYWORD,
                        # EXAMPLES:
                        # 'Ret' , 'Ret' , 'Eos' , 'Ret' , 'Ht' , 'MCHC' , 'Plat' , 'Ht' , 'Lym' , 'Ht'
                        'units': DefaultMappings.KEYWORD,
                        # EXAMPLES:
                        # '%' , '%' , '%' , '%' , '%' , '%' , 'x10_4/uL' , '%' , '%' , '%'
                        'value': DefaultMappings.DOUBLE,
                        # EXAMPLES:
                        # '7.9' , '7.1' , '1' , '5.7' , '37.4' , '34.3' , '108.7' , '44.2' , '79' , '46.3'
                    }
                },
