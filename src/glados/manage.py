...
if __name__ == "__main__":
    ...
    if os.environ.get('RUN_MAIN') != 'true' and len(sys.argv) > 0 and sys.argv[1] == 'runserver':
        import glados.static_files_compiler
        glados.static_files_compiler.compile_coffee()
        glados.static_files_compiler.compile_scss()
