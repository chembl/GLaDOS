  ...
  Settings:
    ...
    ES_INDEXES:
      ...
      TARGET:
        ...
        ID_NAME: 'ESTarget'
        LABEL: 'Targets'
        INDEX_NAME: settings.CHEMBL_ES_INDEX_PREFIX+'target'
      ...
      ASSAY:
        ...
        ID_NAME: 'ESAssay'
        LABEL: 'Assays'
        INDEX_NAME: settings.CHEMBL_ES_INDEX_PREFIX+'assay'
      ...
      DOCUMENT:
        ...
        ID_NAME: 'ESDocument'
        LABEL: 'Documents'
        INDEX_NAME: settings.CHEMBL_ES_INDEX_PREFIX+'document'
      ...
      CELL_LINE:
        ...
        ID_NAME: 'ESCellLine'
        LABEL: 'Cells'
        INDEX_NAME: settings.CHEMBL_ES_INDEX_PREFIX+'cell_line'
      ...
      TISSUE:
        ...
        ID_NAME: 'ESTissue'
        LABEL: 'Tissues'
        INDEX_NAME: settings.CHEMBL_ES_INDEX_PREFIX+'tissue'
    ...
    ES_INDEXES_NO_MAIN_SEARCH:
      ...
      DRUG_INDICATIONS:
        ...
        INDEX_NAME: settings.CHEMBL_ES_INDEX_PREFIX+'drug_indication_by_parent'
        # PATH: Assigned after this declaration using the INDEX_NAME
        #BROWSE_LIST_URL: Drug.getDrugsListURL
