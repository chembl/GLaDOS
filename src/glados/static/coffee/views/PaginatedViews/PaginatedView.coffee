...
glados.views.PaginatedViews.PaginatedView.Cards = glados.views.PaginatedViews.PaginatedView\
...
glados.views.PaginatedViews.PaginatedView.Carousel = glados.views.PaginatedViews.PaginatedView\
  .extend(glados.views.PaginatedViews.DeferredViewsFunctions)\
  .extend(glados.views.PaginatedViews.CardZoomFunctions)\
  .extend(glados.views.PaginatedViews.ItemViewsFunctions)\
  .extend(glados.views.PaginatedViews.PaginationFunctions)

glados.views.PaginatedViews.PaginatedView.Infinite = glados.views.PaginatedViews.PaginatedView\
  .extend(glados.views.PaginatedViews.DeferredViewsFunctions)\
  .extend(glados.views.PaginatedViews.CardZoomFunctions)\
  .extend(glados.views.PaginatedViews.ItemViewsFunctions)\
  .extend(glados.views.PaginatedViews.PaginationFunctions)

glados.views.PaginatedViews.PaginatedView.Table = glados.views.PaginatedViews.PaginatedView\
  .extend(glados.views.PaginatedViews.DeferredViewsFunctions)\
  .extend(glados.views.PaginatedViews.CardZoomFunctions)\
  .extend(glados.views.PaginatedViews.ItemViewsFunctions)\
  .extend(glados.views.PaginatedViews.PaginationFunctions)
